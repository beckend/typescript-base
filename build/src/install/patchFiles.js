...
(async () => {
    ...
    await filePatcher.patchFiles({
        patchList: [
            ...
            {
                onFile: ({ content }) => ({
                    newContent: filePatcher_1.FilePatcher.utils.addWhenNotExist({
                        content: filePatcher_1.FilePatcher.utils.addWhenNotExist({
                            content,
                ...
                pathFileInput: path_1.join(config_1.default.PATH.DIR.ROOT_NODE_MODULES, 'ts-jest/dist/types.d.ts'),
            },
        ],
    });
})();
